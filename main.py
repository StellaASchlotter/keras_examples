...
def i_am_a_cool_loss_function(y_true, y_pred):
    return 0.42
...
layer2 = keras.layers.Dense(20,name="my_cool_intermediate_output", activation=tf.nn.relu)(layer1)
layer3 = keras.layers.Dense(20, activation=tf.nn.relu)(layer2)
layer4 = keras.layers.Dense(1, name="final")(layer3)

model = Model(inputs=layer_in,
                    outputs=[layer2, layer4])

model.compile(optimizer='adam', 
              loss={'my_cool_intermediate_output':i_am_a_cool_loss_function, 'final': "mse"})
